...
exports.serviceEstudiante = void 0;
const express = __importStar(require("express"));
const ConsEstudiante_1 = require("../BD/ConsEstudiante");
class serviceEstudiante {
    ...
    insertarEstudiante(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, ConsEstudiante_1.insertarEstudiate)(datos, (error) => {
                if (error) {
...
exports.serviceEstudiante = serviceEstudiante;
exports.default = serviceEstudiante;
//# sourceMappingURL=EstudianteAPI.js.map